...
class Backend(CSVBackend):
    debug_filename = os.path.join(os.path.dirname(__file__), '../tests/data/paramount_diamonds.csv')
    default_filename = os.path.join(settings.FTP_ROOT, 'paramountgems/diamonds.csv')
