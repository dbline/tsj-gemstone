...
class Backend(CSVBackend):
    ...
    def write_diamond_row(self, line, blank_columns=None):
        ...
        unused_Availability,  # Not used by vendor anyway
        cut,
        carat_weight,
        color,
        clarity,
        ...
        girdle,
        culet,
        unused_Crown_Height,  #not supprted
        unused_Crown_Angle,   #not supprted
        unused_Pavilion_Depth,   #not supprted
        comment,
        country,
        unused_Location,  #could use city
        cert_image,
        v360_link,
        unused_Member_Comments,  #not supprted
        ) = line
