...
class Backend(CSVBackend):
    debug_filename = os.path.join(os.path.dirname(__file__), '../tests/data/diamond_data_simran.csv')
    infile_glob = os.path.join(settings.FTP_ROOT, 'simran-diamond-co/*.csv')
