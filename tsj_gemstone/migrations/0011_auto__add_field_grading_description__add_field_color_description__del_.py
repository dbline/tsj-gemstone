...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Grading.description'
        db.add_column(u'tsj_gemstone_grading', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Color.description'
        db.add_column(u'tsj_gemstone_color', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Deleting field 'Clarity.desc'
        db.delete_column(u'tsj_gemstone_clarity', 'desc')

        # Adding field 'Clarity.description'
        db.add_column(u'tsj_gemstone_clarity', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Grading.description'
        db.delete_column(u'tsj_gemstone_grading', 'description')

        # Deleting field 'Color.description'
        db.delete_column(u'tsj_gemstone_color', 'description')

        # Adding field 'Clarity.desc'
        db.add_column(u'tsj_gemstone_clarity', 'desc',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Deleting field 'Clarity.description'
        db.delete_column(u'tsj_gemstone_clarity', 'description')
