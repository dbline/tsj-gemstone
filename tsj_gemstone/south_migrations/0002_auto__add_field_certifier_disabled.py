...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Certifier.disabled'
        db.add_column('tsj_gemstone_certifier', 'disabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Certifier.disabled'
        db.delete_column('tsj_gemstone_certifier', 'disabled')
