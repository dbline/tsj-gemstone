...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Diamond.cert_image_local'
        db.add_column('tsj_gemstone_diamond', 'cert_image_local',
                      self.gf('django.db.models.fields.files.FileField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Diamond.cert_image_local'
        db.delete_column('tsj_gemstone_diamond', 'cert_image_local')
