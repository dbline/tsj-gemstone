...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Diamond.owner'
        db.alter_column(u'tsj_gemstone_diamond', 'owner', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Diamond.owner'
        db.alter_column(u'tsj_gemstone_diamond', 'owner', self.gf('django.db.models.fields.CharField')(max_length=100))
