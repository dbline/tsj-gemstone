...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Diamond', fields ['carat_weight']
        db.create_index(u'tsj_gemstone_diamond', ['carat_weight'])


    def backwards(self, orm):
        # Removing index on 'Diamond', fields ['carat_weight']
        db.delete_index(u'tsj_gemstone_diamond', ['carat_weight'])
    ...
    models = {
        ...
        u'tsj_gemstone.diamond': {
            ...
            'manmade': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
