...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Diamond.manmade'
        db.alter_column(u'tsj_gemstone_diamond', 'manmade', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'Diamond.manmade'
        db.alter_column(u'tsj_gemstone_diamond', 'manmade', self.gf('django.db.models.fields.BooleanField')())
