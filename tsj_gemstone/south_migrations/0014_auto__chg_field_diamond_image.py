...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Diamond.image'
        db.alter_column(u'tsj_gemstone_diamond', 'image', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Diamond.image'
        db.alter_column(u'tsj_gemstone_diamond', 'image', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
    ...
    models = {
        ...
        u'tsj_gemstone.diamond': {
            ...
            'image_local': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'blank': 'True'}),
