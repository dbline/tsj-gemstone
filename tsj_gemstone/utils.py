...
def detect_backend(filename):
    SHEET_TYPES = {
        ...
        'paramountgems': ['Stock #', 'Shape', 'Carat Weight', 'Color', 'Clarity', 'Cut Grade', 'Price Per Carat', 'List Discount', 'Lab', 'Certificate #', 'Certificate Image', 'Depth %', 'Table %', 'Girdle %', 'Girdle Thin', 'Girdle Thick', 'Culet', 'Polish', 'Symmetry', 'Fluorescence Intensity', 'Fluorescence Color', 'Measurements', 'City', 'State','Country', 'Comments'],
